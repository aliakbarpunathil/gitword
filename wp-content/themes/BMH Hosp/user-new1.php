...
if(isset($_GET['uname'])){
	$update=1;
	global $wpdb;
	$uid = get_user_by('login', $_GET['uname']);
...
<?php if(get_current_user_id()==1){ ?>
	<tr class="form-field" >
		...
		<td><select name="role" id="role">			
				<option <?php if($uid->roles[0] == 'subscriber'){ ?> selected="selected"  <?php } ?> value="subscriber">Subscriber</option>				
				<option <?php if($uid->roles[0] == 'administrator'){ ?> selected="selected" <?php } ?> value="administrator">Administrator</option>			
			</select>
		</td>
	</tr>
<?php } 
