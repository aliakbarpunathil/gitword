                                    ...
                                    <div class="wpcf7" id="wpcf7-f165-p75-o1" lang="en-US" dir="ltr">
                                        ...
                                        <form action="update-profile.php" method="post" enctype="multipart/form-data">
											...
											<p>Date of Birth(dd-mm-yyyy)<span class="text-red">*</span>						
											 ...
											 <p>Profile Photo(Max Size : 200 KB)
                                            <br/>
                                           <img src="<?php echo $pdetails->pro_image; ?>" id="profile_image1" width="150" height="150"/>
                                            ...
                                            <p>Mobile<span class="text-red">*</span>
												...
												<input type="text" name="phone" value="<?php echo $pdetails->phone; ?>" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required " required aria-required="true" pattern="[0-9]{9,14}" title="Type a valid mobile number"/>
												</p>
											<p>Whatsapp Number
                                                <br />
