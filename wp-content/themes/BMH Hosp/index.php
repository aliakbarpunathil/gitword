                ...
                <div class="bg-pos-rel">
                    <div class="pix-con clearfix">
                        <div class="pix-container">
                            <div class="vc_col-sm-12 wpb_column vc_column_container ">
                                <div class="wpb_wrapper">
                                    <div class="tabs event-tab upcoming-popular-tab" style="text-align:left;">
                                        <ul class="clearfix">
                                        ...
                                        <div id="tabs24178972"> 
											<div class="speakers">
												...
												<div class="speaker-img" style="float:right;"><img src="<?php echo get_template_directory_uri(); ?>/wp-content/themes/event/library/img/cmc1.jpg" alt="" width="100%" height="300px" style="max-width:300px;-webkit-backface-visibility: hidden;"></div>
													<div class="speaker-img" style="float:right;"><img src="<?php echo get_the_guid($postid); ?>" alt="" width="100%" height="300px" style="max-width:300px;-webkit-backface-visibility: hidden;"></div>
													
													
													<div class="speaker-content">
													
													<h1>	
														<a href="<?php if(is_user_logged_in()){ echo get_template_directory_uri();?>/event-description.php?p=<?php echo $postid; } else echo wp_login_url( get_template_directory_uri() .'/event-description.php?p='.$postid ); ?>" style="font-size : 32px;"><?php echo get_the_title($postid); ?></a>
														</h1>
