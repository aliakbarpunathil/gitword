...
border-radius: 50%;
   ...
   margin-top : 0px;
    ...
    <section class="events newsection">
	    ...
	    <div class="container">
<h2 class="text-left"> <?php echo stripslashes($threads->title); ?> <?php if(is_super_admin() || $threads->author == get_current_user_id()){ ?>/ <a href="<?php echo get_template_directory_uri(); ?>/discussion-add.php?fid=<?php echo $discussion_id ?>" style="margin-right: 10px;">Edit</a> <?php } ?></h2>	<br/>
