...
$contact_row = $wpdb->get_row('select contact_details, contact_num, form_upload from wp_contact where event_id = '.$postId); 
?>
...
<p><br/>
							...
							<form action="event-confirm.php" method="post">
								...
								<a href="<?php echo $contact_row->form_upload; ?>" download="register"><input type="button" name="download" value="Download Form" class="clearfix btn btn-solid btn-blue btn-md post-10" /></a>
							</form>
