...
<body class="home page page-id-21 page-template-default wpb-js-composer js-comp-ver-4.4.2 vc_responsive">
                            ...
                            <div class="vc_col-sm-6 wpb_column vc_column_container ">
                                <div class="wpb_wrapper">
                                    ...
                                    <div class="wpcf7" id="wpcf7-f165-p75-o1" lang="en-US" dir="ltr">
                                        ...
                                        <form name="loginform" id="" action="loginUser.php" method="post">
                                            <p>USER NAME
                                                <br />
                                                <span class="wpcf7-form-control-wrap your-name"><input type="text" name="log" id="user_login" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" /></span> </p>
                                            <p>PASSWORD
                                                <br />
                                                <span class="wpcf7-form-control-wrap your-email"><input type="password" name="pwd" id="user_pass" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" /></span> </p>
    ...
    <script type='text/javascript'>
        /* <![CDATA[ */
        var _wpcf7 = {
            "loaderUrl": "http:\/\/innwithemes.com\/eventonwp\/wp-content\/plugins\/contact-form-7\/images\/ajax-loader.gif",
            "sending": "Sending ..."
        };
        /* ]]> */
    </script>
    ...
    <script type='text/javascript'>
        ...
        var wc_add_to_cart_params = {
            "ajax_url": "\/eventonwp\/wp-admin\/admin-ajax.php",
