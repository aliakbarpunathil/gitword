...
function wp_insert_user( $userdata ) {
	...
	/** Custom Code @ali akbar  -- email sending**/
	if($user){
		$subject = "New CMCBatch27 Account";
		$message="Your Account is successfully created <br/> Login Name : ".$user_login."<br/> Password : ".$userdata['user_pass']."<br/> please login and change password";
		$headers = array('From: Me Myself <me@example.net>; Content-Type: text/html; charset=UTF-8 ');
