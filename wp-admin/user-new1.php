...
if ( current_user_can( 'create_users') ) {
	if ( $do_both )
		echo '<h2 id="create-new-user" class="main-title title size-md" style="font-weight: 100;" >' . __( 'Add New User' ) . '</h2>';
?>
...
<table class="form-table col-md-9">
	<tr class="form-field form-required">
		...
		<td><input name="user_login" type="text" id="user_login" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" value="<?php echo esc_attr( $new_user_login ); ?>" aria-required="true" autocapitalize="none" autocorrect="off" maxlength="60" /></td>
	</tr>
	<tr class="form-field form-required">
		<th scope="row"><label for="email"><?php _e('Email'); ?> <span class="description"><?php _e('(required)'); ?></span></label></th>
		<td><input name="email" type="email" id="email" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" value="<?php echo esc_attr( $new_user_email ); ?>" /></td>
	</tr>
<?php if ( !is_multisite() ) { ?>
	<tr class="form-field">
		<th scope="row"><label for="first_name"><?php _e('First Name') ?> </label></th>
		<td><input name="first_name" type="text" id="first_name" value="<?php echo esc_attr($new_user_firstname); ?>" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"/></td>
	</tr>
	<tr class="form-field">
		<th scope="row"><label for="last_name"><?php _e('Last Name') ?> </label></th>
		<td><input name="last_name" type="text" id="last_name" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" value="<?php echo esc_attr($new_user_lastname); ?>" /></td>
	</tr>
	<!--tr class="form-field">
		...
		<td>
			...
			<div class="wp-pwd">
				...
				<span class="password-input-wrapper">
					<input type="password" name="pass1" id="pass1" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" autocomplete="off" data-reveal="1" data-pw="<?php echo esc_attr( $initial_password ); ?>" aria-describedby="pass-strength-result" />
				</span>
	...
	<tr class="form-field form-required user-pass2-wrap">
		...
		<td>
		<input name="pass2" type="password" id="pass2" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" autocomplete="off" />
		</td>
	</tr>
